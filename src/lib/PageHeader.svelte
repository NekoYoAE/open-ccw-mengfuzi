...
>
  <a href="/" class="contents" title="homepage">
    <div class="size-12 mt-2 mb-2 ml-2"><Logo /></div>
    <h1
      class="ml-2 overflow-hidden h-14 text-4xl text-white font-bold content-center"
    >
      Open CCW
    </h1>
  </a>

  <div class="justify-self-end h-12 w-auto ml-auto mr-4 flex gap-4">
